...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { team_id_id: @favorite.team_id_id, user_id_id: @favorite.user_id_id } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { team_id_id: @favorite.team_id_id, user_id_id: @favorite.user_id_id } }
